...
| `HINTS.md` | Stage 10 | N/A — no hints for this hunt (5 puzzles, casual audience, self-confirming) |
| `meta/META-DESIGN.md` | Stage 6 | ✅ Complete — WOLOLO crossword, 5 answer words (CASTLE, ONAGER, LOOM, TOWER, PATROL) |
| `puzzles/` | Stage 7 | ✅ Complete — 5 puzzles authored, 1 redesigned, all pass |
| `tests/` | Stage 8-9 | ✅ Complete — 15 blind tests + 4-agent live test. All pass. |
| `reviews/` | — | Empty |
| `tests/` | — | Empty |
