...
\centering
\begin{tikzpicture}[
  box/.style={draw, rounded corners, minimum height=1cm, minimum width=3.2cm, text centered, font=\small, fill=gray!8},
  wbox/.style={draw, rounded corners, minimum height=1cm, minimum width=3.2cm, text centered, font=\small, fill=blue!8},
...
\begin{axis}[
    ...
    symbolic y coords={{Fun (FN)},{Elegance (EL)},{Rdg.\ Reward (RR)},{Confirmation (CQ)},{Solvability (SO)},{Clarity (CL)}},
    ytick=data,
...
\addplot+[]
coordinates {
    (0.88,{Clarity (CL)})      +- (0.22,0.08)
    (0.84,{Solvability (SO)})  +- (0.26,0.11)
    (0.86,{Confirmation (CQ)}) +- (0.23,0.10)
    (0.74,{Rdg.\ Reward (RR)}) +- (0.37,0.17)
    (0.68,{Elegance (EL)})     +- (0.42,0.21)
    (0.52,{Fun (FN)})          +- (0.49,0.29)
};
\end{axis}
\end{tikzpicture}
