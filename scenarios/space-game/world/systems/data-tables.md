...
**Companion to:** `world-spacegamiverse.md`, `world-systems-detail.md`
...
|------|------|----------|---------------|
| **Bridge — Center** | 1 | COMMAND_CHAIR (×1) | Command Suite — ship status, alerts, crew |
| **Bridge — Helm** | 1 | HELM (×1) | Navigation Suite — sensors, deflector, course |
| **Bridge — Tactical** | 1 | TACTICAL (×1) | Tactical Suite — sensors, weapons, shields |
| **Bridge — OPS** | 1 | OPS (×1) | OPS Suite — comms, enviro, transit overview |
| **Bridge — Science** | 1 | SCIENCE (×1) | Science Suite — science ops, sensors |
| **Ready Room** | 1 | AUXILIARY (×1) | Command Suite (private) |
| **Briefing Room** | 1 | AUXILIARY (×4) | Configurable per meeting |
| **Main Engineering — Power** | 5 | ENGINEERING (×4) | Reactor, EPS, batteries, distribution |
| **Main Engineering — Propulsion** | 5 | ENGINEERING (×4) | Thrusters, impulse, warp core, nacelles |
| **Main Engineering — Computer** | 5 | ENGINEERING (×3) | Computer core, ODN, diagnostics |
| **Main Engineering — Damage Control** | 5 | ENGINEERING (×3) | DC coordination, repair teams, maintenance |
| **EPS Control** | 5 | ENGINEERING (×2) | Power distribution grid |
| **Environmental Control** | 5 | ENVIRONMENTAL (×2) | Life support, atmosphere, gravity |
| **Deflector Control** | 5 | ENGINEERING (×2) | Nav deflector operations |
| **Transporter Room 1** | 2 | TRANSPORTER (×2) | Pad A ops, Pad B ops |
| **Transporter Room 2** | 2 | TRANSPORTER (×2) | Pad C ops, Pad D ops |
| **Emergency Transport Bay** | 5 | TRANSPORTER (×2) | Emergency pads (20-person) |
| **Sickbay — Main** | 3 | MEDICAL (×3) | Diagnosis, treatment, stasis |
| **Science Lab** | 4 | SCIENCE (×4) | Research, analysis, experiments |
| **Security Office** | 4 | SECURITY (×3) | Internal sensors, access control, brig |
| **Brig** | 4 | SECURITY (×1) | Containment fields, prisoner vitals |
| **Armory** | 4 | SECURITY (×1) | Weapons locker, equipment checkout |
| **Cargo Bay** | 4 | OPS (×1) | Cargo manifest, environmental monitoring |
| **Personal Quarters** | 3 | AUXILIARY (×1) | Personal Suite — messages, schedule, logs |
| **Senior Quarters** | 3 | AUXILIARY (×1) | Personal Suite (expanded access) |
| **Mess Hall** | 3 | AUXILIARY (×2) | Public Terminal — replicator, directory, schedule |
| **Corridor Terminals** | All | AUXILIARY (×varies) | Public Terminal — limited access |
