...
# Brent Holman — Reviewer Profile

## Identity
- **Role**: Co-founder and Game Master, Shinteki; co-creator of ClueKeeper
- **Affiliation**: Shinteki (2001–present), ClueKeeper (2013–present), Bay Area puzzle/escape room community
- **Partner**: Linda Holman (co-founder of Shinteki, "Director of Adventure")
- **Background**: Former creative writer turned full-time puzzle event designer

## Puzzle Hunt Credentials

### Shinteki — Co-Founder (2001)
- Co-founded Shinteki in 2001 with Linda Holman and four friends
- Serves as Game Master — the primary creative and operational lead
- Name comes from a Japanese word meaning "mental," "physical," or "psychological" — Shinteki events embody all three
- Runs the Shinteki Decathlon series — flagship 10-puzzle road rally events combining puzzles, physical challenges, and scenic locations throughout the Bay Area
- Decathlon series has run 10+ iterations, becoming a benchmark for polished, accessible puzzle hunt design
- Also runs corporate puzzle events through Shinteki

### ClueKeeper — Co-Creator (2013)
- Co-created ClueKeeper with Rich Bragg in 2013
- GPS-aware iOS/Android platform for building and playing puzzle hunts
- Incorporates puzzle hunt, escape room, and augmented reality features
- Enables anyone to create self-running puzzle hunts — democratizing the format beyond the Game Control elite

### Escape Room Design
- Transitioned Shinteki's design expertise into escape rooms
- Featured in Stanford Magazine for their escape room design approach
- Rooms use adaptive technology: sensors adjust difficulty based on team size and solving speed
- "We won't let you fail at the room" — timed hints deploy in increasingly obvious ways if a team struggles
...
- [About Shinteki](http://www.shinteki.com/about.html)
- [Shinteki — Home](https://www.shinteki.com/)
- [ClueKeeper — Wikipedia](https://en.wikipedia.org/wiki/ClueKeeper)
- [ClueKeeper review — Room Escape Artist](https://roomescapeartist.com/2017/09/18/cluekeeper-puzzle-hunt-app-review/)
- [Shinteki Decathlon 5 review — motris (Thomas Snyder)](https://motris.livejournal.com/72150.html)
