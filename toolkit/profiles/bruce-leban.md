...
# Bruce Leban — Reviewer Profile

## Identity
- **Role**: Software developer, puzzle constructor, game creator
- **Affiliation**: Co-founder of Microsoft Puzzlehunt (1999), National Puzzlers' League (assistant editor of *The Enigma*)
- **Published**: *Jumping to Conclusions* (hangman riddles book), NYT crossword constructor
- **Notable**: Coined the term "puzzlehunt" (1998)
...
- Active NPL member bringing crossword and flat-puzzle traditions into the puzzlehunt format
...
- [Microsoft Puzzle Hunt — Wikipedia](https://en.wikipedia.org/wiki/Microsoft_Puzzle_Hunt)
- [NYT crossword with David Steinberg (2015)](https://www.xwordinfo.com/Crossword?date=4/23/2015)
- [List of Microsoft Puzzlehunts — Puzzle Wiki](https://www.puzzles.wiki/wiki/List_of_Microsoft_Puzzlehunts)
