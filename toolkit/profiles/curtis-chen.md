...
# Curtis Chen — Reviewer Profile

## Identity
- **Role**: Puzzle hunt organizer, podcaster, writer, actor
- **Affiliation**: Team Snout (Bay Area), co-founder of Puzzled Pint (Portland), GC Summit organizer
- **Podcast**: SnoutCast (213 episodes, 2009–2015) — the documentary record of Bay Area puzzle hunt culture
- **Published**: Science fiction author (*Waypoint Kangaroo* series), puzzle hunt resources

## Puzzle Hunt Credentials

### Team Snout — Core Member
- Part of Team Snout, one of the most active puzzle hunt teams in the Bay Area
- Maintained the Game Control information page at snout.org — a key community resource
- With DeeAnn Sole, co-hosted SnoutCast, interviewing puzzle designers and Game runners
- Team Snout organized and sponsored the GC Summit (Game Control Summit) from 2007–2014 — an annual gathering for puzzle hunt creators to share knowledge

### GC Summit — Organizer
- The GC Summit was the puzzle hunt community's design conference — simulcast between Mountain View, CA and Redmond, WA (later adding Portland, OR)
- Ran for at least 10 years, featuring talks on puzzle design, event management, and community building
- Created the institutional memory of the Bay Area/Seattle Game community

### Puzzled Pint — Co-Founder (2010)
- Co-founded Puzzled Pint in Portland, OR with Ana Roeszler, DeeAnn Sole, Matt Cleinman, and Victor Asteinza (July 2010)
- Puzzled Pint is a monthly puzzle event at bars — a low-barrier entry point into puzzle culture
- The format has spread to cities worldwide, becoming one of the most successful puzzle community-building events ever created

### JoCo Cruise Puzzle Hunts
- Designed and ran complete puzzle hunts on the JoCo Cruise (Jonathan Coulton fan cruise) for multiple years
- Adapted puzzle hunt format for a captive audience on a ship — constrained space, diverse skill levels

### Ignite Portland
- Gave "How to Solve Any Puzzle in Less Than 47 Minutes" at Ignite Portland 7 (2009) — a rapid-fire introduction to puzzle hunt solving for a general audience
...
- [Curtis C. Chen's Journal — puzzles](https://www.curtiscchen.com/journal/category/puzzles/)
- [SnoutCast #26: "Why YOU Should Run a Game"](https://www.curtiscchen.com/journal/2010/07/26/snoutcast-26-why-you-should-run-a-game/)
- [SnoutCast #44: "This Clue Is Not The Game"](http://hotsheet.snout.org/2010/12/snoutcast-44-this-clue-is-not-game.html)
- [Puzzled Pint — Puzzle Wiki](https://www.puzzles.wiki/wiki/Puzzled_Pint)
- [How to Solve Any Puzzle in Less Than 47 Minutes — Ignite Portland](http://hotsheet.snout.org/2009/11/how-to-solve-any-puzzle-in-less-than-47.html)
