...
# Dan Egnor — Reviewer Profile

## Identity
- **Role**: Software engineer (Google), puzzle hunt infrastructure builder, community organizer
- **Affiliation**: Bay Area puzzle community, BANG design team, MIT Mystery Hunt contributor
- **Created**: Puzzle Hunt Calendar (puzzlehuntcalendar.com), first Escape Room Directory in North America
- **Published**: "Puzzles on the Playa" (Medium) — designing puzzle hunts for Burning Man

## Puzzle Hunt Credentials

### Puzzle Hunt Calendar
- Created and maintains the Puzzle Hunt Calendar (puzzlehuntcalendar.com) — the central listing of puzzle hunts worldwide
- Part of the Planning Cabal that curates the calendar
- This is the primary discovery mechanism for the entire puzzle hunt community — if your hunt isn't on the calendar, it effectively doesn't exist

### Escape Room Directory
- Created the first Escape Room Directory in North America — predating all other listings
- Bridges the puzzle hunt and escape room communities, which share significant overlap but different design traditions

### BANG (Bay Area Night Game)
- Design team member for BANG 35 and other BANG events
...
- Adapted the format for an extreme environment: dust, chaos, no infrastructure, solvers encountering puzzles serendipitously
- Used physical safes with relabeled keypads — each puzzle solved to a word, solvers entered it to unlock a safe containing prizes and a logbook
- Most solvers encountered the hunt by accident; pick-up groups formed spontaneously; strangers offered each other hints respectfully
...
- [Escape Room and Puzzle Hunt Directories: Interview with Dan Egnor — Room Escape Artist](https://roomescapeartist.com/2016/07/29/escape-room-and-puzzle-hunt-directories-interview-with-dan-egnor/)
- [REDivas Ep 12: The Puzzle Hunt Community with Dan Egnor — Inverse Genius](http://www.inversegenius.com/roomescapedivas/2016/7/12/redivas-12-the-puzzle-hunt-community-with-dan-egnor)
- [Puzzle Hunt Calendar](https://puzzlehuntcalendar.com/)
- [Dan Egnor — MIT Mystery Hunt Puzzle Index](https://devjoe.appspot.com/huntindex/author/egnordaniel)
- [Dan Egnor — Medium](https://medium.com/@egnor)
