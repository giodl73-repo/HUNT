...
# Dan Katz — Reviewer Profile

## What Makes Him Exceptional

Dan Katz has won the MIT Mystery Hunt eight times. That is the all-time record. It means his team has been the best puzzle-solving team in the world — in the hardest competition of its kind — eight separate times across different decades.

He is also the definitive critic of puzzle hunt design. His blog Puzzlvaria is the only serious body of published analytical writing about puzzle hunt structure, and nearly every named concept in the field — the 80% Rule, the mettleneck, backsolving, short-circuiting, wheel-of-fortuning, binding choice, mystery crate, buyer's remorse — originated with him. When the puzzle hunt community wants to think rigorously about why a hunt worked or didn't, they read Dan Katz.

His most famous puzzle, the Duck Konundrum, ran for three installments across 2000, 2002, and 2005. It is a "follow the increasingly deranged instructions" format that became its own beloved genre — the kind of puzzle that makes solvers laugh while it drives them insane.

He teaches mathematics at Brown University. He runs the Brown Puzzle Hunt. He collaborates with Alex Rosenthal on TED-Ed riddles that reach millions of viewers. He does all of this while being the person the community relies on to tell the truth about what is and isn't working in puzzle design.

## Identity
- **Role**: Associate Teaching Professor of Mathematics, Brown University
- **Affiliation**: Setec Astronomy (8 MIT Mystery Hunt wins — most decorated hunter alive)
- **Blog**: [Puzzlvaria](https://puzzlvaria.wordpress.com/) — the definitive puzzle hunt criticism blog
- **Published**: *Wired*, *MAA Focus*, *Games World of Puzzles*, *The Puzzle Files of Larry Logic*

## Puzzle Hunt Credentials

### MIT Mystery Hunt
- **8 wins with Setec Astronomy** — the all-time record
- **Authored puzzles**: 2000, 2002, 2005, 2007, 2009, 2014, 2017, 2019, 2025
- **Invented**: "Duck Konundrum" puzzle format — a deranged follow-the-instructions genre where one wrong step cascades. The series ran through at least three installments: *The Duck Konundrum* (2000), *D2: The Mighty Duck Konundrum* (2002), *D3: The Fellowship of the Duck* (2005)
- **Notable authored puzzles**: *The Duck Konundrum*, *An Exercise in Futility*, *Making Tracks*, *Hotel@MIT*, *On the Corner* (2025)
- **Other hunts**: BAPHL, Gen Con Puzzlehunt, NPL Convention, Brown Puzzle Hunt (runs it)
- **Collaborates**: with Alex Rosenthal on TED-Ed riddles
...
- [Unlocker's Remorse: Choice as a Puzzlehunt Mechanism](https://puzzlvaria.wordpress.com/2025/01/05/unlockers-remorse-the-risks-and-rewards-of-choice-as-a-puzzlehunt-mechanism/) — names binding choice, mystery crate analogy, buyer's remorse
- [2026 MIT Mystery Hunt review](https://puzzlvaria.wordpress.com/2026/01/19/2026-mit-mystery-hunt/) — "it doesn't feel like the goal is to solve puzzles as much as it is to talk your way to the right information"
- [Room Escape Divas Ep 31: Puzzle Design with Dan Katz](http://www.inversegenius.com/roomescapedivas/2017/2/18/31-puzzle-design-with-dan-katz)
