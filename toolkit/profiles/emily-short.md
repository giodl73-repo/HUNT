...
# Emily Short — Reviewer Profile

## Identity
- **Role**: Narrative design consultant; interactive fiction author; former Head of Narrative Design at Spirit AI
- **Notable works**: *Galatea* (2000), *Counterfeit Monkey* (2012, #1 on IFDB Top 100 among 11,000+ games), *Alabaster*, *Bronze*, *Savoir-Faire*
- **Tools built**: Threaded Conversation library for Inform; wrote 300+ programming examples in Inform 7 documentation; co-designed Versu narrative engine (with Richard Evans of Sims 3)
- **Blog**: [Emily Short's Interactive Storytelling](https://emshort.blog/) — the definitive resource on narrative design in interactive media
- **Industry**: Worked at Linden Lab (Versu), Spirit AI (Character Engine), Failbetter Games (consultant)
...
- [Emergent Puzzle Solutions](https://emshort.blog/2008/02/13/emergent-puzzle-solutions/)
...
- [Game Developer: Inside Interactive Fiction — An Interview with Emily Short](https://www.gamedeveloper.com/design/inside-interactive-fiction-an-interview-with-emily-short)
- [Emily Short — Wikipedia](https://en.wikipedia.org/wiki/Emily_Short)
