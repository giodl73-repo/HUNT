...
# Foggy Brume — Reviewer Profile

## Identity
- **Role**: Puzzle constructor, publisher, puzzle hunt designer
- **Affiliation**: Creator of P&A Magazine (2006–present), Puzzle Boat series (9+ editions), Phoenix, AZ
- **Published**: *Tinseltown Logic Puzzles* (Sterling), P&A Magazine (bimonthly since 2006), Puzzle Boat 1–9
- **Coined**: The "ISIS" puzzle classification (Identify, Sort, Index, Solve)
- **Background**: Lifelong passion for movies (since age 9) and puzzles (since age 10)
...
- "A puzzle solving extravaganza in the style of the MIT Mystery Hunt" — designed for teams of 4–6
- Solutions to individual puzzles feed into metapuzzles, which feed into an overall puzzle — full layered meta architecture
- Kickstarter-funded (Puzzle Boat 4 onward), demonstrating the audience willingness to pay for quality
- Described as "always smart, fair, and well-constructed" (Dan Katz, Puzzlvaria)

### Puzzle Design Education
- Published puzzle-writing tips in three parts — widely referenced in the puzzle community
...
- [P&A Magazine — home](https://www.pandamagazine.com/)
- [Puzzle Boat 4 — Kickstarter](https://www.kickstarter.com/projects/400891659/puzzle-boat-4)
- [Puzzlehunts for the Sophisticated Quarantiner — Puzzlvaria (mentions Puzzle Boat)](https://puzzlvaria.wordpress.com/2020/03/17/puzzlehunts-for-the-sophisticated-quarantiner/)
- [The Puzzle Publication I've Always Wanted — GeekDad](https://geekdad.com/2016/01/pa-magazine-puzzles/)
- [Foggy Brume's puzzle-writing tips — EnigMarch resources](https://enigmarch.com/resources/)
