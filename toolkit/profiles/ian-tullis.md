...
# Ian Tullis — Reviewer Profile

## Identity
- **Role**: Senior CS Curriculum Developer at Art of Problem Solving; puzzle constructor
- **Affiliation**: Shinteki (primary puzzle author), Stanford University, Bay Area puzzle community
- **Published**: NYT crossword constructor, trivia writer for LearnedLeague and UK game show *Only Connect*
- **Speaking**: GC Summit 2014 — "Advice from (and for) a Puzzle Snob" (widely regarded as essential viewing for puzzle designers)
...
### Other Hunts
- Microsoft Puzzlehunt contributor
- The (first and only) Google Puzzle Hunt
- BANG (Bay Area Night Game) — weekend driving games
- Various Bay Area puzzle events

### Crosswords & Trivia
- NYT crossword constructor
...
- [How to Write a BANG Puzzle — BayAreaNightGame.org](http://www.bayareanightgame.org/index.php/How_to_Write_a_BANG_Puzzle)
- [Ian Tullis — MIT Mystery Hunt Puzzle Index](https://devjoe.appspot.com/huntindex/author/tullisian)
- [Category: Puzzles by Ian Tullis — Puzzle Wiki](https://www.puzzles.wiki/wiki/Category:Puzzles_by_Ian_Tullis)
- [Ian Tullis — Stanford](https://explorecourses.stanford.edu/instructor/itullis)
- [Ian Tullis — Art of Problem Solving](https://theorg.com/org/art-of-problem-solving/org-chart/ian-tullis)
